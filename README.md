...
Para correr el proyecto hace falta tener instalados NodeJS (probado con 8.6.0) y `yarn` (probado con 1.1.0).

Instalar las dependencias con `yarn install`, y ejecutar con `yarn start`. Esto va a abrir un browser en http://localhost:3000/, que se actualiza automágicamente a medida que modificamos el código original.

## Acá empieza el README default de la app React

Lo guardo por si en un futuro nos interesa aprender cosas sobre ello
